...
출력:
    output/kric_hc/station_ui_bundle.json        전체 458역 (압축 표기)
    output/kric_hc/station_ui_bundle.sample.json 스키마 + 3개 역만 (context 투입용)
...
LAYOUT = ROOT / "output" / "kric_hc" / "station_layout.json"
OUT = ROOT / "output" / "kric_hc" / "station_ui_bundle.json"
OUT_SAMPLE = ROOT / "output" / "kric_hc" / "station_ui_bundle.sample.json"
